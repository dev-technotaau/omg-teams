// ──────────────────────────────────────────────
//  ISO 3166-1 alpha-2 country code → centroid
//
//  Used by login-anomaly.service.ts to compute
//  great-circle distance between successive login
//  countries for impossible-travel detection.
//
//  Centroids are approximate (geographic centre of
//  each country) — accurate to ~few hundred km, more
//  than sufficient for trans-continental velocity
//  checks at 1000 km/h thresholds.
//
//  Source: public CC0 dataset (gavinr/world-countries-centroids)
//  Hand-curated for ISO 3166-1 alpha-2 only.
// ──────────────────────────────────────────────
...
export const COUNTRY_CENTROIDS: Record<string, Centroid> = {
  ...
  KI: { lat: -3.3704, lon: -168.734 },
  KM: { lat: -11.6455, lon: 43.3333 },
  KN: { lat: 17.3578, lon: -62.783 },
  KP: { lat: 40.3399, lon: 127.5101 },
  KR: { lat: 35.9078, lon: 127.7669 },
  KW: { lat: 29.3117, lon: 47.4818 },
  KY: { lat: 19.3133, lon: -81.2546 },
  ...
  MP: { lat: 17.3308, lon: 145.3847 },
  MQ: { lat: 14.6415, lon: -61.0242 },
  MR: { lat: 21.0079, lon: -10.9408 },
  MS: { lat: 16.7425, lon: -62.1874 },
  ...
  NC: { lat: -20.9043, lon: 165.618 },
  NE: { lat: 17.6078, lon: 8.0817 },
  NF: { lat: -29.0408, lon: 167.9547 },
  ...
  WF: { lat: -13.7687, lon: -177.1562 },
  WS: { lat: -13.759, lon: -172.1046 },
  XK: { lat: 42.6026, lon: 20.903 },
  YE: { lat: 15.5527, lon: 48.5164 },
  YT: { lat: -12.8275, lon: 45.1662 },
 ...
 * Uses the haversine formula — accurate to ~0.5% for any pair of points
 * on Earth.
 */
