...
export default function AdminTargetsPage() {
  ...
  // Server state — targets, scoped to current filters.
  ...
  // Summary stats — exclude global defaults from "unique recruiters" count
  // since they don't represent a single person.
  ...
  const detailRenderer = useCallback(
    (t: Target) => {
      ...
      rows.push(["Status", t.isActive ? "Active" : "Inactive"]);
